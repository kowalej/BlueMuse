...
Full version history for BlueMuse.
- _See the [README](./README.md) for current features, installation, and usage instructions._
...
* Added Muse S Athena support (see Muse S Athena).
